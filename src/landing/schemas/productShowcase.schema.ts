...
export const productShowcaseSchema = z.object({
  ...
  productImages: z.object({
    ...
    items: z.array(productImageSchema).min(1, 'At least one product image is required'),
  }),
  ...
  features: z.object({
    title: z.string().optional(),
    subtitle: z.string().optional(),
    items: z.array(productFeatureSchema).min(3, 'At least 3 features are required'),
  }),
...
export type ProductShowcaseData = z.infer<typeof productShowcaseSchema>;
